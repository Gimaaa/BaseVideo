...
-(void)buildLayout
{
    ...
    backLayer.strokeColor  = [UIColor colorWithRed:250.0/255.0f green:250.0/255.0f blue:250.0/255.0f alpha:1].CGColor;
    ...
    [gradientLayer setColors:[NSArray arrayWithObjects:(id)[RGB(49, 181, 153) CGColor],(id)[RGB(49, 181, 153) CGColor], nil]];
